...
func TestInscription(t *testing.T) {
	...
	// paymentWif, _ := bitcoin.CreateWifString()
	// paymentWif := os.Getenv("ORD_PAYMENT_WIF")
	// // The data signature to use when inscribing
	// signingWif := os.Getenv("ORD_SIGNING_WIF")
	// // The key of the wallet to hold the 1sat ordinals
	// ordinalWif := os.Getenv("ORD_ORDINAL_WIF")

	paymentWif := "KxLN6LddUYp73R5MeSUfKvcBGQYpdhKEa3mtJvZcQATNX5uHrnkQ"
	// The data signature to use when inscribing
	signingWif := "L55ps1X49y9r8rGSoCFprsnGVnH6YZdzGS5tyFGVaiMX5LYGnt2J"
	// The key of the wallet to hold the 1sat ordinals
	ordinalWif := "L32BRRZgdpdDXyZQyAzp8RBTBxNhLkx6URnQjtiqshYRTwngP9LS"
	// Get satchel address
